...
Uso
python main.py          # cámara integrada (índice 0)
python main.py 1        # cámara externa
Configuración
...
- La resolución real de la cámara se muestra en la consola al iniciar.
- Los errores clearcut de MediaPipe son inofensivos (telemetría fallando).